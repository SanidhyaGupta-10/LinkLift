...
const Card = () => {
  return (
    <StyledWrapper className='flex flex-col justify-center items-center mt-6  p-10'>
      <div className="card  shadow-md  bg-gradient-to-r from-teal-400 via-cyan-500 to-blue-700 text-white">
        <div className="img" />
        <span>About Me</span>
        <p className="info">
          I’m Sanidhya Gupta, I'm class-9th and I'm MERN stack developer, a multidisciplinary designer who focuses on telling my clients’
